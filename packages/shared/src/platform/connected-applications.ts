...
export const CONNECTED_APPLICATION_RUNTIME: readonly ConnectedApplicationRuntime[] =
  [
    ...
    },
    {
      ...
      evidence:
        "POST /api/v1/connectors/civio/events evaluates. ALLOW ≠ EXECUTED. No authoritative tool/target/artifact on Civio events.",
    },
    {
      ...
      execute: "NONE",
      ingest: "NONE",
      evidence: "Portfolio Governance seed only. ADR-022 observe-only.",
    },
    {
