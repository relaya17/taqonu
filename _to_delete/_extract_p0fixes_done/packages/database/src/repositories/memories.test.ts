  ...
  it("inserts owner_id and snake_case columns on create", async () => {
    ...
    globalThis.fetch = vi.fn(async (url: unknown, init?: RequestInit) => {
      ...
      if (urlStr.includes("/rest/v1/memories")) {
        ...
        return new Response(
          JSON.stringify({ ...toRow(sampleMemory), owner_id: "22222222-2222-4222-8222-222222222222" }),
    ...
    const result = await repo.create(sampleMemory, "22222222-2222-4222-8222-222222222222");
    ...
    expect(insertedRow.owner_id).toBe("22222222-2222-4222-8222-222222222222");
