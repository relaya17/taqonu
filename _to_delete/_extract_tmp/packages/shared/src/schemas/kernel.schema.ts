...
export const taskPlanSchema = z.object({
  id: uuidSchema,
  // Must stay >= the max() on kernelRunRequestSchema.request /
  // createTaskPlanRequestSchema.request (8000) — createTaskPlan() feeds the
  // raw request straight into this field, so a smaller cap here rejects
  // otherwise-valid API requests with a confusing 400.
