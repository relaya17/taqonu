      ...
      <Box>
        <Typography
          ...
          sx={{
            ...
            // Motion-only entrance (WCAG 1.4.3 fix): the previous
            // opacity:0->1 fade meant axe-core (and a real user, briefly)
            // could observe this heading at a fraction of full opacity —
            // measured at ~22% through the 700ms transition, the blended
            // color against the page background dropped to ~1.6:1
            // contrast, well under the 3:1 minimum for large/bold text.
            // Animating translateY only keeps the entrance effect while
            // the text is always rendered at full, spec-passing contrast.
