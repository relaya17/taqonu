...
<body>
  ...
  <div class="container">
    ...
    <div class="panel" id="panel-agents">
      ...
      <p class="muted" style="margin-bottom:12px;color:var(--text-muted);font-size:13px;">Oversight list only. Profiles at /api/v1/agent-profiles govern personal memory and professional knowledge separately and do not grant execution. A professional-only agent is denied personal memory. Owner isolation stays first. Marketplace listings at /api/v1/marketplace/listings are not agents. A listing references an admitted professional agent and a release. Fabric membership, oversight membership, and professional scope do not by themselves create a marketplace professional agent. Provider, publisher, evidence tier, eligibility, entitlement, and access status stay separate. Access evaluation does not dispatch and does not grant personal memory. Provider claims are not verified evidence. Rental, purchase, and licensing are not offered here.</p>
