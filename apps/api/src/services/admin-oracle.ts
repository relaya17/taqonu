...
export function buildAdminOracleShell(input?: {
  ...
  return {
    ...
    roadmap: [
      ...
      { id: "A1.3", title: "Version instability detector", status: "PARTIAL" },
      { id: "A1.4", title: "Daily hi-tech / advisory brief", status: "PARTIAL" },
      { id: "A1.5", title: "Defensive cyber feed → Graph", status: "PARTIAL" },
      { id: "A1.6", title: "Automation audit trail", status: "PARTIAL" },
      { id: "A1.7", title: "Morning digest Top-3 actions", status: "PARTIAL" },
    ],
    allowlist: ALLOWLIST,
    dailyBrief: {
      date,
